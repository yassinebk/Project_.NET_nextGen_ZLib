...
namespace Project.Models
{
    public class Book
    {
        ...
        [Display(Name = "Author")] public Author? BookAuthor { set; get; }

        public Int32 AuthorId { set; get; }
        public string Genre { set; get; } = String.Empty;

        [DataType(DataType.Currency)] public float Price { set; get; } = 0.0f;

        [Display(Name = "Number of Pages")] public Int32 NumberOfPages { get; set; }

        [Display(Name = "Publisher")] public Publisher? BookPublisher { get; set; }
